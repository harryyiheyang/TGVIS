---
title: "Data Prepartion"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{data-download-02}
...
We **strongly recommend** using the LD matrices provided by SBayesRC as input to TGVIS. We have implemented a helper function to construct the required LD matrix:
...
```
In addition, empirical observations show that per-SNP heritability typically ranges between 0.1 and 0.3 across traits. A robust default is to set: Per-SNP heritability = 0.2 / 1e6 and Inflation factor = 1.1. 
