...
TGVIS assumes that a set of xQTLs influence the products of genes (e.g., expressions and splicing events) at a locus.
...
TGVIS accounts for a polygenic architecture of genetic effects, wherein, aside from the direct causal variants with relatively large effects, the genetic variants have infinitesimal effects that are modeled through a normal distribution with mean zero and small variance.
...
The data can be downloaded from [example-data.zip](https://www.dropbox.com/scl/fi/7ljyj4mc4nmpixzj0l253/example-data.zip?rlkey=s4r4158sow4h9i3nthyy9s7k1&st=fcb0u9tc&dl=0).  
For a step-by-step guide on how to use TGVIS for data analysis, please refer to the tutorial: [Data-analysis-using-TGVIS.pdf](Data-analysis-using-TGVIS.pdf).
...
For any questions or issues, please contact Yihe Yang at \url{yxy1234@case.edu}.
